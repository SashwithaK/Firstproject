        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <button
              ...
              className="flex items-center gap-3 px-10 py-5 bg-gradient-to-r from-green-500 to-emerald-500 hover:from-green-600 hover:to-emerald-600 text-white rounded-2xl font-bold text-lg shadow-2xl transition-all duration-300 transform hover:scale-105"
            >
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 20 20">
      ...
      <footer className="bg-gradient-to-r from-gray-900 to-gray-800 text-white py-8 mt-20">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-gray-400 mt-2">
            © 2024 Handwritten Form Extraction System. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
